    ...
    <div style={div1Style}>
      <div style={div4Style}>
        <nav style={navs}>
          ...
          <ul style={menuStyle}>
            <li style={styleli}><Link to={'/login/Employer/Profile'} style={{ color: col, textDecoration: st, }}
                onMouseEnter={() => { setCol("#E6DF2A"); setSt("underline"); }}
                onMouseLeave={() => { setCol("#AAA7C1"); setSt("none"); }}>Profile</Link></li>
            <li style={styleli}>
              <Link to={'/login/Employer/offre'} style={{ color: '#E6DF2A', textDecoration: 'none', }}>Offrers</Link>
            </li>
            <li style={styleli}><Link to={'/login/Employer/demande'} style={{ color: coll, textDecoration: stt }}
              ...
              onMouseLeave={() => { setColl("#AAA7C1"); setStt("none"); }}>Demande</Link></li>
