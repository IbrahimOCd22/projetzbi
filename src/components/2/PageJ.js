    ...
    <form method='Post' action=''>
      <div style={div1Style}>
        ...
        <div style={{ ...div3, marginTop: "200px", }}>
          ...
          <Link to={"/signup/cvcandida/Education"}><button style={buttonI}><span style={spanI}>+</span> add new</button></Link>
        </div>
        <Link to={"/signup/cvcandida/autre"}> <input type='submit' value={"next -->"} style={{ ...button, position: 'absolute', top: "410px", left: "940px" }} /></Link>
